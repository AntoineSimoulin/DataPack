...
htmlhelp_basename = '{{ cookiecutter.package_name }}doc' # repo_name
...
latex_documents = [
    ('index',
     '{{ cookiecutter.package_name }}.tex', # repo_name
...
man_pages = [
    ('index', '{{ cookiecutter.package_name }}', u'{{ cookiecutter.package_name }} Documentation', # repo_name
...
texinfo_documents = [
    ('index', '{{ cookiecutter.package_name }}', u'{{ cookiecutter.package_name }} Documentation', # repo_name
     u"{{ cookiecutter.author_name }}", '{{ cookiecutter.package_name }}',
